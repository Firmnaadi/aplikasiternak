...
<body>
    ...
    if (isset($_POST['Submit'])) {
        ...
        $result = mysqli_query($conn, "INSERT INTO penjualan_ayam(jumlah, harga, berat, tanggal) VALUES('$jumlah','$harga','$berat','$tanggal')");
    
        $jumlah = $_POST['jumlah'] * $_POST['harga'] * $_POST['berat'];
