            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="penjulan_telur.php">telur</a>
                    </div>
                </div>
            </li>
               ...
               <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="pembelian_ayam.php">Pembelian Ayam</a>
                        <a class="collapse-item" href="pembelian_kbth_aym.php">Pembelian Kebutuhan Ayam</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="penjualan_ayan.php">Ayam</a>
                        ...
                        <a class="collapse-item" href="pendapatan_tlr.php">telur</a>
                        <h6 class="collapse-header">Pengeluaran</h6>
                        <a class="collapse-item" href="pengeluaran_aym.pho">Ayam</a>
                        <a class="collapse-item" href="pengeluaran_keb_yam.php">Kebutuhan Ayam</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="Inkar.php">Input Karyawan</a>
